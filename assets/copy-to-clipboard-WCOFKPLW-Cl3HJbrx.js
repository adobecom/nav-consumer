import{t as h}from"./utils-C7VFI3GZ-DZ1T-Fb4.js";function a(l,i){if(!l||!i)return i;const e=h("button",{style:"background: none; border: none; padding: 0; cursor: pointer;",title:"Copy"},`<svg xmlns="http://www.w3.org/2000/svg" height="18" viewBox="0 0 18 18" width="18">
        <defs>
          <style>
            .fill {
              fill: #464646;
